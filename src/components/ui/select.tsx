...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        `data-[size=sm]:rounded-[min(var(--radius-md),10px)] min-w-0 flex w-fit
        items-center justify-between gap-1.5 overflow-hidden rounded-lg border
        ...
        *:data-[slot=select-value]:block *:data-[slot=select-value]:min-w-0
        *:data-[slot=select-value]:flex-1 *:data-[slot=select-value]:truncate
