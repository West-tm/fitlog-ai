...
2. 「指示文 一覧」→「新規作成」から指示文を保存（例：「増量中なので強気な提案を」）
3. 「新規作成」からメッセージを入力し、AI 回答を生成
4. 生成されたAI回答が保存され、「AI回答 一覧」と「AI回答の詳細」から確認できる
...
- AI 連携：指示文＋メッセージを Gemini API に送信してAIフィードバックを取得・保存・削除
